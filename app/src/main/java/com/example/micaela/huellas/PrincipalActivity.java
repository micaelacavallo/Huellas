...
public class PrincipalActivity extends BaseActivity {
    ...
    private void setTabsTextStyle(TabLayout tabLayout) {
        ...
        try {
            ...
            txtTab1.setTextAppearance(this, R.style.condensed_normal_17);
            txtTab2.setTextAppearance(this, R.style.condensed_normal_17);
            txtTab3.setTextAppearance(this, R.style.condensed_normal_17);
